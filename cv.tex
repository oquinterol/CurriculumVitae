...
% Configuración de ruta de firma: vector trazado desde PNG a SVG path.
% Se incluye el PDF vectorial generado desde assets/signature/Firma-Alexis-path.svg
% para evitar incrustar la firma como imagen raster copiable desde el PDF final.
\newcommand{\signaturepath}{assets/signature/Firma-Alexis-path.pdf}
...
\ifthenelse{\equal{\cvlang}{spanish}}{
    \position{Licenciado en Biología y Magíster en Bioinformática}
    \makecvfooter{\today}{Oscar A. Quintero López~~~·~~~Hoja de Vida}{\thepage}
    \quote{``Piensa antes de escribir.''}
}{
    \position{B.Sc. in Biology and M.Sc. in Bioinformatics}
...
\IfFileExists{\signaturepath}{\input{cv-sections/signature.tex}}{}
%----------------------------------------------------------------------------------------
